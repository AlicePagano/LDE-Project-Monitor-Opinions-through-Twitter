...
\begin{figure}[t]
   \begin{minipage}[l]{1.0\columnwidth}
   \centering
   \includegraphics[width=1\textwidth]{imag
   e/word_2017-2020.pdf}
...
Tab. \ref{tab:inhab-activity} shows $A$ compared to the number of inhabitants $I$ by region. The third column quantifies how active on Twitter a region is with respect to its number of inhabitants: the autonomous province of Bolzano is the least active, followed by Molise and most of the southern regions. Also North-East regions are less active than populated. On the contrary there are many Twitter users in Lazio, Liguria, Toscana, Lombardia and Emilia Romagna.
	...
	\centering
	\subfloat[][2017]{\includegraphics[width=0.8\textwidth]{image/map/map_2017.png} \label{fig:map_result_a} }
	\end{minipage}
	\begin{minipage}[]{0.49\linewidth}
	\centering
	\subfloat[][2018]{\includegraphics[width=0.8\textwidth]{image/map/map_2018.png} \label{fig:map_result_b} }
	\end{minipage} \\
	\vfill
	\begin{minipage}[c]{0.49\linewidth}
	\centering
	\subfloat[][2019]{\includegraphics[width=0.8\textwidth]{image/map/map_2019.png} \label{fig:map_result_c} }
	\end{minipage}
	\begin{minipage}[]{0.49\linewidth}
	\centering
	\subfloat[][2020]{\includegraphics[width=0.8\textwidth]{image/map/map_2020.png} \label{fig:map_result_d} }
	\end{minipage}
